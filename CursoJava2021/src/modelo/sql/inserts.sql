...
insert into figuras(fig_tipo, fig_nombre, fig_base, fig_altura)  values(4,"triangulo1", 10, 8.4)
insert into figuras(fig_tipo, fig_nombre, fig_base, fig_altura)  values(3,"rect1", 12.3, 8.4)
insert into figuras(fig_tipo, fig_nombre, fig_lado, fig_numlados, fig_apotema)  values(2,"cir1", 6, 6.2)
